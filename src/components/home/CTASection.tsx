...
const CTASection = () => {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-primary rounded-3xl p-10 md:p-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button className="bg-black text-white hover:bg-black/90 rounded-xl px-6 py-3 h-auto gap-3">
          ...
          <Button variant="outline" className="bg-white text-black hover:bg-gray-100 border-0 rounded-xl px-6 py-3 h-auto gap-3">
            <span className="text-left">
