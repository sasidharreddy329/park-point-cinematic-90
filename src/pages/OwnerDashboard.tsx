...
import { Plus, Trash2, MapPin, DollarSign, LayoutGrid, Eye } from "lucide-react";
                ...
                {tab === "slots" ? (
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {bookings.length === 0 ? (
                      ...
                      bookings.map(b => (
                        <div key={b.id} className="flex items-center justify-between p-3 border border-border rounded-xl">
                          <div>
